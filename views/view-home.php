...
<body style="padding-top: 56px;">
  ...
  <div class="container grid">
    ...
    <button id="theme-series" class="theme-button" data-theme="Séries TV" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Séries TV</button>
    <button id="theme-cinema" class="theme-button" data-theme="Cinéma" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Cinéma</button>
    <button id="theme-horreur" class="theme-button" data-theme="Films d'horreur" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Films d'horreur</button>
    <button id="theme-acteursActrices" class="theme-button" data-theme="Actrices/acteurs" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Actrices/Acteurs</button>
    <button id="theme-animes" class="theme-button" data-theme="Animes" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Animes</button>
    <button id="theme-comedies" class="theme-button" data-theme="Comédies" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Comédies</button>
    <button id="theme-telerealite" class="theme-button" data-theme="Téléréalité" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Téléréalité</button>
  </div>
