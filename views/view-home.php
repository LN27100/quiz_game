...
<body style="padding-top: 56px;">
  ...
  <div class="box">
    ...
    <span></span>
    <span></span>
      <p id="question-title">Mon Titre</p>
  </div>
</div>
  ...
  <div class="container grid">
    <button id="theme-dessins" class="theme-button" data-theme="Thème dessins animés" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Dessins animés</button>
    <button id="theme-series" class="theme-button" data-theme="Thème séries TV" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Séries TV</button>
    ...
    <button id="theme-horreur" class="theme-button" data-theme="Thème films d'horreur" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Films d'horreur</button>
    <button id="theme-acteursActrices" class="theme-button" data-theme="Thème actrices/acteurs" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Actrices/Acteurs</button>
    <button id="theme-animes" class="theme-button" data-theme="Thème animes" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Animes</button>
    <button id="theme-comedies" class="theme-button" data-theme="Thème comédies" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Comédies</button>
    <button id="theme-telerealite" class="theme-button" data-theme="Thème téléréalité" data-playerPseudo="<?php echo $pseudo; ?>">Thème <br> Téléréalité</button>
  </div>
