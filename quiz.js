...
const questionsDessinsAnimes = [
  ...
  {
    question:
      "Quel est le nom des quatre tortues ninja dans 'Les Tortues Ninja' ?",
    options: [
      "Leonardo, Michelangelo, Donatello, Raphael",
      "Leonardo, Rocksteady, Donatello, Baxter",
      "Leonardo, Donatello, Tommy, Jason",
      "Leonardo, Donatello, Casey, April",
    ],
  ...
  {
    question:
      "Quel est le nom du héros principal dans 'Les Mystérieuses Cités d'or' ?",
  ...
  {
    question:
      "Quel est le nom du dessin animé mettant en scène des petits ours multicolores dotés de pouvoirs magiques ?",
...
const questionsSeries = [
  {
    question:
      "Quel est le nom du café où les personnages de 'Friends' passent beaucoup de temps ?",
  ...
  {
    question:
      "Quel est le nom du groupe de survivants dirigé par Rick Grimes dans 'The Walking Dead' ?",
...
const questionsGeographie = [
  ...
  {
    question:
      "Quelle est le plus long fleuve de France, s'étendant sur environ 1,012 kilomètres ?",
