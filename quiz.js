...
const questionsChansons = [
  ...
  const questionsDessinsAnimes = [
    ...
    {
        numéro: "11/20",
        question: "Quel est le nom du petit garçon qui devient ami avec un dragon dans 'Peter et Elliott le dragon' ?",
        options: ["Peter", "Elliott", "Jack", "David"],
        answer: "Peter",
      },
      {
        numéro: "12/20",
        question: "Dans quel dessin animé des années 90 un groupe de bébés s'évade-t-il régulièrement de leur garderie ?",
        options: ["Les Bisounours", "Les Razmoket", "Les Fruittis", "Les Tiny Toons"],
        answer: "Les Razmoket",
      },
      {
        numéro: "13/20",
        question: "Quel est le nom du dragon qui accompagne Mulan dans le film Disney éponyme ?",
        options: ["Mushu", "Khan", "Shenzi", "Cri-Kee"],
        answer: "Mushu",
      },
      {
        numéro: "14/20",
        question: "Dans quel dessin animé une petite fille appelée Dora part-elle à l'aventure avec son singe et ses amis ?",
        options: ["Dora l'Exploratrice", "La Maison de Mickey", "Paw Patrol", "Bob l'éponge"],
        answer: "Dora l'Exploratrice",
      },
      {
        numéro: "15/20",
        question: "Quel est le nom du lion de mer ami de Nemo dans 'Le Monde de Nemo' ?",
        options: ["Marlin", "Dory", "Bruce", "Gill"],
        answer: "Gill",
      },
      {
        numéro: "16/20",
        question: "Dans quel dessin animé des années 80 une petite fille nommée Candy vit-elle une série d'aventures ?",
        options: ["Bouba", "Candy Candy", "Georgie", "Princesse Sarah"],
        answer: "Candy Candy",
      },
      {
        numéro: "17/20",
        question: "Quel est le nom du chien fidèle qui accompagne Sherlock Holmes dans une adaptation en dessin animé ?",
        options: ["Rex", "Milou", "Pluto", "Snoopy"],
        answer: "Milou",
      },
      {
        numéro: "18/20",
        question: "Dans quel dessin animé des années 90 un groupe d'enfants voyage-t-il dans le temps à bord d'une machine volante ?",
        options: ["Il était une fois... l'Homme", "Les Chevaliers du Zodiaque", "Inspecteur Gadget", "Les Minipouss"],
        answer: "Les Minipouss",
      },
      {
        numéro: "19/20",
        question: "Quel est le nom du dinosaure violet ami de Bob dans 'Bob le bricoleur' ?",
        options: ["Rex", "Barney", "Dino", "Bubulle"],
        answer: "Barney",
      },
      {
        numéro: "20/20",
        question: "Dans quel dessin animé une petite fille rousse et son chien nommé Toby vivent-ils de nombreuses aventures ?",
        options: ["Calimero", "Lucile, Amour et Rock'n Roll", "Princesse Sarah", "Tom-Tom et Nana"],
    ...
    const questionsCuisine = [
      ...
      const questionsHarry = [
        ...
        const questionsGeographie = [
            ...
            {
              numéro: "20/20",
              question: "Quel est le plus long fleuve de France, s'étendant sur environ 1,012 kilomètres ?",
          ...
          const questionsOrthographe = [
            ...
            const questionsSport = [
              ...
              const questionsAnimaux = [
                ...
                {
                  numéro: "20/20",
                  question: "Quel animal a le plus petit cerveau en proportion de sa taille ?",
              ...
              const questionsCinema = [
                ...
                {
                  numéro: "9/20",
                  question: "Quel film d'animation de 2022 réalisé par Angus MacLane explore les origines du personnage cosmonaute en uniforme blanc et vert ?",
                  options: [
                    "Buzz l'Éclair",
                    "Toy Story 4",
                ...
                {
                  numéro: "10/20",
                  question: "Quel film de 1980 réalisé par Stanley Kubrick est une adaptation d'un roman de Stephen King mettant en scène un hôtel hanté ?",
