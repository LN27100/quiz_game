...
class Scores
{
     ...
     */
    public static function create(int $playerId, string $theme, int $score)
    {
        try {
            ...
            $sql = "INSERT INTO scores (player_id, theme, score) 
                    VALUES (:player_id, :theme, :score)";

            // Préparation de la requête
            $query = $db->prepare($sql);

            // Relier les valeurs aux marqueurs nominatifs
            $query->bindValue(':player_id', $playerId, PDO::PARAM_INT);
    ...
    /**
     * Méthode permettant de récupérer les scores d'un utilisateur avec son id comme paramètre
     * 
     * @return array Tableau associatif contenant les infos de l'utilisateur
     */
    public static function getInfos(int $player_id): array
    {
        try {
            ...
            // Stockage de la requête dans une variable
            $sql = "SELECT * FROM scores WHERE player_id = :player_id";
